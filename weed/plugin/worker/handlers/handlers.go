...
import (
	...
	_ "github.com/seaweedfs/seaweedfs/weed/worker/tasks/ec_bitrot_scan" // register ec_bitrot_scan handler
	_ "github.com/seaweedfs/seaweedfs/weed/worker/tasks/ec_vacuum"      // register ec_vacuum handler
